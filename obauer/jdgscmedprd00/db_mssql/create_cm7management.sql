...
( NAME = N'cm7management', FILENAME = N'G:\Microsoft SQL Server\MSSQL10_50.MSSQLSERVER\MSSQL\Data\cm7management.mdf' , SIZE = 3072KB , FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'cm7management_log', FILENAME = N'O:\Microsoft SQL Server\MSSQL10_50.MSSQLSERVER\MSSQL\Data\cm7management_log.ldf' , SIZE = 1024KB , FILEGROWTH = 10%)
GO
