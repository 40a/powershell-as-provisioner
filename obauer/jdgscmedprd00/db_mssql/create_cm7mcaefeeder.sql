...
( NAME = N'cm7mcaefeeder', FILENAME = N'G:\Microsoft SQL Server\MSSQL10_50.MSSQLSERVER\MSSQL\Data\cm7mcaefeeder.mdf' , SIZE = 3072KB , FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'cm7mcaefeeder_log', FILENAME = N'O:\Microsoft SQL Server\MSSQL10_50.MSSQLSERVER\MSSQL\Data\cm7mcaefeeder_log.ldf' , SIZE = 1024KB , FILEGROWTH = 10%)
GO
