...
( NAME = N'cm7httpcache', FILENAME = N'G:\Microsoft SQL Server\MSSQL10_50.MSSQLSERVER\MSSQL\Data\cm7httpcache.mdf' , SIZE = 3072KB , FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'cm7httpcache_log', FILENAME = N'O:\Microsoft SQL Server\MSSQL10_50.MSSQLSERVER\MSSQL\Data\cm7httpcache_log.ldf' , SIZE = 1024KB , FILEGROWTH = 10%)
GO
